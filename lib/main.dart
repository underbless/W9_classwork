...
class GuestBookMessage {
  GuestBookMessage(
      {required this.name, required this.message, required this.time, required this.userId, required this.docId});
  final String name;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                          '${DateTime.fromMicrosecondsSinceEpoch(message.time * 1000)}'),
                    ),
                    SizedBox(height: 16),
                  ],
                ),
